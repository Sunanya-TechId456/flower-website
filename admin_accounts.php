...
// Delete admin account using MySQLi
if (isset($_GET['delete'])) {
    $delete_id = $_GET['delete'];
    $delete_admin = mysqli_prepare($conn, "DELETE FROM `admin` WHERE id = ?");
    mysqli_stmt_bind_param($delete_admin, "i", $delete_id);
...
<section class="accounts">
   ...
   <?php
   // Select admin accounts using MySQLi
   $select_account = mysqli_prepare($conn, "SELECT * FROM `admin`");
   mysqli_stmt_execute($select_account);
